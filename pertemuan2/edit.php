...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container">
			<a class="navbar-brand" href="index.php">Aprily Amanda J3C218166</a>
		...
		<form action="edit.php?id=<?php echo $id; ?>" method="post">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					...
					<div class="form-check">
						<input class="form-check-input" type="checkbox" name="olahraga[]" value="Lari" <?php if ($data['olahraga'] == 'Lari') {
																											echo 'checked';
																										} ?>>
						<label class="form-check-label">
							Lari
					...
					<div class="form-check">
						<input class="form-check-input" type="checkbox" name="olahraga[]" value="Berenang" <?php if ($data['olahraga'] == 'Berenang') {
																											echo 'checked';
																										} ?>>
						<label class="form-check-label">
							Berenang
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					...
					<label class="form-check-label" disabled>Mohon maaf belom bisa update gambar</label>
				</div>
			</div>
			<div class="form-group row">
